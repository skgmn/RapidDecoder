...
public interface IImageLineSetFactory<T extends IImageLine> {
	 ...
	 *            Image info
	 * @param singleCursor
	 *            : we intend to read one row at a time, if possible, and we are
	 *            not interested in keeping the line in memory
	 * @param nlines
	 *            : how many lines we want the ImageLineSet to store
	 * @param noffset
